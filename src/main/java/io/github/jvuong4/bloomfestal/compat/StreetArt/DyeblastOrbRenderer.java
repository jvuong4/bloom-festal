...
import net.minecraft.resources.Identifier;
	...
	public class DyeblastOrbRenderer extends EntityRenderer<DyeblastOrb, EntityRenderState> {
		...
		public DyeblastOrbRenderer(final EntityRendererProvider.Context context) {
			super(context);
