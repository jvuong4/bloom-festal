...
public class StillnessOrbRenderer extends EntityRenderer<StillnessOrb, EntityRenderState> {
	...
	public StillnessOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
