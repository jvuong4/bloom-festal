...
import io.github.jvuong4.bloomfestal.entity.SilenceOrb;
...
public class SilenceOrbRenderer extends EntityRenderer<SilenceOrb, EntityRenderState> {
	...
	public SilenceOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
