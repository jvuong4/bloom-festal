...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.BlueDyeblastOrb;
...
public class BlueDyeblastItem extends DyeblastItem {
	public BlueDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		BlueDyeblastOrb entity = new BlueDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
