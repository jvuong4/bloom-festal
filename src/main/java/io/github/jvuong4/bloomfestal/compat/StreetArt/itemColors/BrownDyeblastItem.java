...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.BrownDyeblastOrb;
...
public class BrownDyeblastItem extends DyeblastItem {
	public BrownDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		BrownDyeblastOrb entity = new BrownDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
