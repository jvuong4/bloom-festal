...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.WhiteDyeblastOrb;
...
public class WhiteDyeblastItem extends DyeblastItem {
	public WhiteDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		WhiteDyeblastOrb entity = new WhiteDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
