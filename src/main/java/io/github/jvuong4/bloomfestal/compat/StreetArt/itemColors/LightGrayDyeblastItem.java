...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.LightGrayDyeblastOrb;
...
public class LightGrayDyeblastItem extends DyeblastItem {
	public LightGrayDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		LightGrayDyeblastOrb entity = new LightGrayDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
