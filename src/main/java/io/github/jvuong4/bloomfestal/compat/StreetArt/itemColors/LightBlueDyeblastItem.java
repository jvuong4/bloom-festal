...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.LightBlueDyeblastOrb;
...
public class LightBlueDyeblastItem extends DyeblastItem {
	public LightBlueDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		LightBlueDyeblastOrb entity = new LightBlueDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
