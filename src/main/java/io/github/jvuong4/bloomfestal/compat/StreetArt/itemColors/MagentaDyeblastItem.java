...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.MagentaDyeblastOrb;
...
public class MagentaDyeblastItem extends DyeblastItem {
	public MagentaDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		MagentaDyeblastOrb entity = new MagentaDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
