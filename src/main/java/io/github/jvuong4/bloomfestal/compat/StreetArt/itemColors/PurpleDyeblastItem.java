...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.PurpleDyeblastOrb;
...
public class PurpleDyeblastItem extends DyeblastItem {
	public PurpleDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		PurpleDyeblastOrb entity = new PurpleDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
