...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.CyanDyeblastOrb;
...
public class CyanDyeblastItem extends DyeblastItem {
	public CyanDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		CyanDyeblastOrb entity = new CyanDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
