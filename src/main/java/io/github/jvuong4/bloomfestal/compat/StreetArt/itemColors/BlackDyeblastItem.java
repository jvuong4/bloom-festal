...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.BlackDyeblastOrb;
...
public class BlackDyeblastItem extends DyeblastItem {
	public BlackDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		BlackDyeblastOrb entity = new BlackDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
