...
import io.github.jvuong4.bloomfestal.entity.WhirlpoolOrb;
...
public class WhirlpoolOrbRenderer extends EntityRenderer<WhirlpoolOrb, EntityRenderState> {
	...
	public WhirlpoolOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
