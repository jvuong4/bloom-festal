...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.GrayDyeblastOrb;
...
public class GrayDyeblastItem extends DyeblastItem {
	public GrayDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		GrayDyeblastOrb entity = new GrayDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
