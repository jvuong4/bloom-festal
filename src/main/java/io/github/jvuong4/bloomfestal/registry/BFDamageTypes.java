...
public class BFDamageTypes {
	...
	public static final ResourceKey<DamageType> BLOSSOM_REJECT_DAMAGE = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(BloomFestal.ID, "blossom_reject"));
