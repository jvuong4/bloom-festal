...
public class HexingOrb extends StatusEffectOrb {
	...
	protected void initVals()
	{
		...
		damageParticle = ParticleTypes.DAMAGE_INDICATOR;
	}

	@Override
	public Holder<MobEffect> getStatusEffect()
	{return BFEffects.HEXED;}
