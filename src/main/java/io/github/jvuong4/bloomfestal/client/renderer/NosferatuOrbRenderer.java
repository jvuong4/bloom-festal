...
public class NosferatuOrbRenderer extends EntityRenderer<NosferatuOrb, EntityRenderState> {
	...
	public NosferatuOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
