...
public class RexcaliburOrbRenderer extends EntityRenderer<RexcaliburOrb, EntityRenderState> {
	...
	public RexcaliburOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
