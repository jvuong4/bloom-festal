...
public class BolganoneOrbRenderer extends EntityRenderer<BolganoneOrb, EntityRenderState> {
	...
	public BolganoneOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
