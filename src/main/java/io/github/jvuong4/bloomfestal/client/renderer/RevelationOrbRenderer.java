...
public class RevelationOrbRenderer extends EntityRenderer<RevelationOrb, EntityRenderState> {
	...
	public RevelationOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
