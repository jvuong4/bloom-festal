...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.YellowDyeblastOrb;
...
public class YellowDyeblastItem extends DyeblastItem {
	public YellowDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		YellowDyeblastOrb entity = new YellowDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
