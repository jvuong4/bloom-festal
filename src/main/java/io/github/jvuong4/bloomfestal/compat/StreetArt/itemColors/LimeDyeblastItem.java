...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.LimeDyeblastOrb;
...
public class LimeDyeblastItem extends DyeblastItem {
	public LimeDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		LimeDyeblastOrb entity = new LimeDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
