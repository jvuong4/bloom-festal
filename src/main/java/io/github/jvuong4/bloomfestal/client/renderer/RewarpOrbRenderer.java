...
public class RewarpOrbRenderer extends EntityRenderer<RewarpOrb, EntityRenderState> {
	...
	public RewarpOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
