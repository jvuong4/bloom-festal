...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.OrangeDyeblastOrb;
...
public class OrangeDyeblastItem extends DyeblastItem {
	public OrangeDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		OrangeDyeblastOrb entity = new OrangeDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
