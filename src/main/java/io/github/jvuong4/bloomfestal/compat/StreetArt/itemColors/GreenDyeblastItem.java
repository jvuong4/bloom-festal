...
import io.github.jvuong4.bloomfestal.compat.StreetArt.orbColors.GreenDyeblastOrb;
...
public class GreenDyeblastItem extends DyeblastItem {
	public GreenDyeblastItem(final Properties properties) {
		super(properties);
	}
	...
	public void summonDyeblast(ServerLevel serverLevel, Player player, InteractionHand hand, ItemStack itemStack)
	{
		...
		GreenDyeblastOrb entity = new GreenDyeblastOrb(serverLevel, player, (direction.normalize()).scale(d));
