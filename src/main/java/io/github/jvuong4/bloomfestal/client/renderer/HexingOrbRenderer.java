...
public class HexingOrbRenderer extends EntityRenderer<HexingOrb, EntityRenderState> {
	...
	public HexingOrbRenderer(final EntityRendererProvider.Context context) {
		super(context);
